...
export default function handler(req, res) {
  ...
  if (error) {
    res.status(400).send(`<!doctype html><html><head><meta charset="utf-8"><title>Egleze · TikTok auth failed</title><style>${css}</style></head>
<body><div class="card">
  <div class="eyebrow">Egleze · TikTok</div>
  ...
  if (!code) {
    res.status(400).send(`<!doctype html><html><head><meta charset="utf-8"><title>Egleze · TikTok callback</title><style>${css}</style></head>
<body><div class="card">
  <div class="eyebrow">Egleze · TikTok</div>
  <h1><span class="e">N</span>o authorisation code received.</h1>
  <p class="lead">This page is only used as the OAuth redirect target. Open the TikTok authorisation URL from your terminal to begin.</p>
</div></body></html>`);
    return;
  }

  res.status(200).send(`<!doctype html><html><head><meta charset="utf-8"><title>Egleze · TikTok authorised</title><style>${css}</style></head>
<body><div class="card">
  <div class="eyebrow">Egleze · TikTok</div>
