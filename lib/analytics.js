...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://kerijdhiasrvaxssjqqg.supabase.co';
...
async function writeAnalyticsRow(row) {
  if (!SERVICE_KEY) return { stored: false, reason: 'missing_service_key' };
