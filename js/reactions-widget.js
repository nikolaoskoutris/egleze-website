...
(function () {
  ...
  var css = ''
   ...
   +   '.egr-pop::before{content:"";display:block;width:38px;height:4px;border-radius:3px;background:#d8d4ca;margin:0 auto 8px}'
   +   '.egr-pop .egr-h{padding:0 8px 2px}'
   +   '.egr-pop .egr-hs{padding:0 8px 6px;margin-bottom:4px}'
   +   '.egr-pop [data-egr-list]{padding-top:2px}'
   + '}'
